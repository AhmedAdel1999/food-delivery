...
import { faUser,faBars,faTimes,faCartShopping, faPlus, faMinus } from "@fortawesome/free-solid-svg-icons"
...
const Navbar = () =>{
    ...
    return(
        <div className={`w-full bg-bgColor ${scrollPosition>=70?"fixed z-50 top-0 bg-white ":""} flex justify-between items-center py-2 px-16`}>
            <div className="flex flex-col items-center gap-2">
                ...
                />
                <h5 className="text-darkerText font-extrabold whitespace-nowrap">Tasty Treat</h5>
            </div>
            ...
            <ul className="flex items-center list-none gap-6">
                ...
                <li>
                    <Link to={"/login"}><FontAwesomeIcon className="iconstyle" icon={faUser} /></Link>
                </li>
                {
                    (isSmallScreen)?
                    open?
                                            ...
                                            <div key={item.id} className="flex gap-x-2">
                                                ...
                                                <div className="w-full flex items-center justify-between">
                                                    <div className="flex flex-col gap-y-3">
                                                        <h6 className="text-darkerText text-sm font-bold">
                                                            {item.title}
                                                        </h6>
